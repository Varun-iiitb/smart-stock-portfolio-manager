...
def plot_live_price():
    ...
    fig.write_html("C:/Users/varun/tradesight_app/backend/live_stock_prices.html")
    return 'plot_live_price', 204  # 204 No Content (valid, and no browser popup)
...
def plot_profit_loss(username,export_png = False):
    ...
    fig.write_html("C:/Users/varun/tradesight_app/backend/profit_loss.html")

    if (export_png):
        fig.write_image("C:/Users/varun/tradesight_app/backend/profit_loss.png")
...
def portfolio_value(username,start_date=None, end_date=None,export_png = False):
    ...
    fig.write_html("C:/Users/varun/tradesight_app/backend/portfolio_value.html")
    if export_png:
        fig.write_image("C:/Users/varun/tradesight_app/backend/portfolio_value.png")
...
def candle_stick_graph(stock_name,ticker_symbol, start_date, end_date):
    ...
    fig.write_html("C:/Users/varun/tradesight_app/backend/candlestick_chart.html")
...
def predict():
    ...
    ticker_symbol = search_ticker(stock_name)
    string1 , string2 = final_prediction_code.data(ticker_symbol)


    return jsonify({"message1": string1, "message2": string2})
...
def export():
    ...
    portfolio_value(username, start_date="2024-01-01", end_date="2025-07-01", export_png=True) 
    ...
    with pd.ExcelWriter(filepath,engine="xlsxwriter") as writer:
        ...
        worksheet.insert_image("J2", "C:/Users/varun/tradesight_app/backend/profit_loss.png")
        worksheet.insert_image("J30", "C:/Users/varun/tradesight_app/backend/portfolio_value.png")
